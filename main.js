...
app.get("/", (req, res) => {
    res.json({
        ...
        endpoints: {
            ...
            solana: {
                "POST /api/solana/init": "Инициализация Solana клиента (Umi)",
                "GET /api/solana/status": "Статус подключения (Umi)",
                "POST /api/solana/collection": "Создать коллекцию игры (Umi)",
                "POST /api/solana/mint-nft": "Создать NFT предмета (Umi)",
                "POST /api/solana/list-nft": "Выставить NFT на продажу (Umi)",
                "GET /api/solana/nft/:mint": "Метаданные NFT (Umi)",
                "GET /api/solana/wallet/balance": "Баланс кошелька (Umi)",
            },
            solanaWeb3: {
                "POST /api/solana/web3/init": "🔥 Инициализация Web3.js клиента с вашим ключом",
                "GET /api/solana/web3/status": "🔥 Статус Web3 подключения",
                "POST /api/solana/web3/create-collection": "🔥 Создать NFT коллекцию",
                "POST /api/solana/web3/mint-nft": "🔥 Создать NFT для игрового предмета",
                "POST /api/solana/web3/batch-mint": "🔥 Массовое создание NFT",
                "GET /api/solana/web3/nft/:mint": "🔥 Информация о NFT",
                "GET /api/solana/web3/balance": "🔥 Баланс кошелька",
                "POST /api/solana/web3/send-sol": "🔥 Отправить SOL (тестирование)",
            },
            status: {
