  ...
  const initialGames: Game[] = [
    {
      ...
      image: "/src/assets/game-fantasy-quest.jpg",
      category: "RPG",
      status: "active",
      nftCount: 15,
      totalVolume: 45.2,
    ...
    },
    {
      ...
      image: "/src/assets/game-cyber-city.jpg",
      category: "FPS",
      status: "active",
      nftCount: 23,
      totalVolume: 67.8,
    ...
    },
    {
      ...
      image: "/src/assets/game-magic-realm.jpg",
      category: "RPG",
      status: "active",
      nftCount: 18,
      totalVolume: 32.1,
    ...
    },
    {
      ...
      image: "/src/assets/game-space-warriors.jpg",
      category: "FPS",
      status: "active",
      nftCount: 12,
      totalVolume: 28.5,
    ...
    },
    {
      ...
      image: "/src/assets/game-battle-arena.jpg",
      category: "Action",
      status: "active",
      nftCount: 8,
      totalVolume: 19.3,
